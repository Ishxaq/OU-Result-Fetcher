...
def scrape_student_results_between_range(url, start_roll_number, end_roll_number):
...
scrape_student_results_between_range(url, start_roll_number, end_roll_number)
